...
namespace Microsoft.Psi.CognitiveServices.Vision
{
    ...
    public static class Operators
    {
        ...
        /// <param name="policy">The delivery policy. If not specified, the default delivery policy used is <see cref="DeliveryPolicy.LatestMessage"/></param>
        ...
        /// </remarks>
        public static IProducer<ProjectOxford.Vision.Contract.Tag[]> GetTags(this IProducer<Shared<Imaging.Image>> source, string subscriptionKey, DeliveryPolicy policy = null)
        {
            policy = policy ?? DeliveryPolicy.LatestMessage;
            ...
            source.PipeTo(imageAnalyzer.In, policy);
