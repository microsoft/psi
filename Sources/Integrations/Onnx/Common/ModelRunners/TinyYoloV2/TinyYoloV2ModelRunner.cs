...
namespace Microsoft.Psi.Onnx
{
    ...
    /// </remarks>
    public class TinyYoloV2ModelRunner
        : ConsumerProducer<Shared<Image>, TinyYoloV2DetectionResults>, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TinyYoloV2ModelRunner"/> class.
        /// </summary>
        ...
        /// </remarks>
        public TinyYoloV2ModelRunner(Pipeline pipeline, string modelFileName, int? gpuDeviceId = null, string name = nameof(TinyYoloV2ModelRunner))
            : base(pipeline, name)
        {
