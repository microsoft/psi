...
namespace Microsoft.Psi.Visualization.Views.Visuals3D
{
    ...
    /// <summary>
    /// Represents a depth image visual.
    /// </summary>
    public class DepthImageAs3DMeshVisual3D : ModelVisual3D
    {
        private DepthImageAs3DMeshVisualizationObject visualizationObject;
        private MeshGeometry3D meshGeometry;
        private Point3D[] depthFramePoints;
        private int[] rawDepth;

        /// <summary>
        /// Initializes a new instance of the <see cref="DepthImageAs3DMeshVisual3D"/> class.
        /// </summary>
        /// <param name="visualizationObject">The depth image 3D visualization object.</param>
        public DepthImageAs3DMeshVisual3D(DepthImageAs3DMeshVisualizationObject visualizationObject)
        {
