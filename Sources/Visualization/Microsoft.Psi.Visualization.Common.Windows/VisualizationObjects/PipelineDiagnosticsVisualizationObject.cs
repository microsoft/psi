...
namespace Microsoft.Psi.Visualization.VisualizationObjects
{
    ...
    /// </summary>
    [VisualizationObject("Visualize Diagnostics", null, IconSourcePath.Diagnostics, IconSourcePath.Diagnostics)]
    public class PipelineDiagnosticsVisualizationObject : Instant2DVisualizationObject<PipelineDiagnostics>
    {
        ...
        /// <inheritdoc />
        [IgnoreDataMember]
        public override string IconSource => this.StreamBinding.IsBound ? this.IsLive ? IconSourcePath.DiagnosticsLive : IconSourcePath.Diagnostics : IconSourcePath.StreamUnbound;
