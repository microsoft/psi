...
namespace Microsoft.Psi.Visualization.Summarizers
{
    ...
    /// </summary>
    [Summarizer]
    public class NullableIntRangeSummarizer : Summarizer<int?, int?>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NullableIntRangeSummarizer"/> class.
        /// </summary>
        public NullableIntRangeSummarizer()
