...
namespace Microsoft.Psi.Visualization.Summarizers
{
    ...
    /// </summary>
    [Summarizer]
    public class NullableLongSeriesRangeSummarizer : Summarizer<Dictionary<string, long?>, Dictionary<string, long?>>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NullableLongSeriesRangeSummarizer"/> class.
        /// </summary>
        public NullableLongSeriesRangeSummarizer()
