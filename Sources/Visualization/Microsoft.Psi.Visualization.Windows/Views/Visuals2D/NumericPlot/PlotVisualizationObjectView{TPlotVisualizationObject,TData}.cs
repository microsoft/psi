        ...
        where TPlotVisualizationObject : PlotVisualizationObject<TData>, new()
    {
        ...
        protected override void OnDataCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.Action == NotifyCollectionChangedAction.Add)
            {
                ...
                foreach (var item in e.NewItems)
                {
                    ...
                    this.AddPoint(value.OriginatingTime, this.VisualizationObject.GetNumericValue(value.Data));
                }
            ...
            else if (e.Action == NotifyCollectionChangedAction.Reset)
            {
                ...
                if (this.VisualizationObject.Data != null && this.VisualizationObject.Data.Count > 0)
                {
                    ...
                    {
                        this.AddPoint(point.OriginatingTime, this.VisualizationObject.GetNumericValue(point.Data));
                    }
                }
            }
            else
            ...
            if (e.Action == NotifyCollectionChangedAction.Add)
            {
                foreach (var item in e.NewItems)
                {
                    ...
                    this.AddRange(
                        ...
                        this.VisualizationObject.GetNumericValue(range.Value),
                        this.VisualizationObject.GetNumericValue(range.Minimum),
                        this.VisualizationObject.GetNumericValue(range.Maximum));
                }
            }
            else if (e.Action == NotifyCollectionChangedAction.Reset)
            {
        ...
        private void ReRenderMarkers()
        {
            ...
            foreach (var value in dataPoints)
            {
                ...
                Point point = new Point(time.TotalSeconds, this.VisualizationObject.GetNumericValue(value.Data));
