...
namespace Microsoft.Psi.Visualization.VisualizationObjects
{
    ...
    /// </summary>
    /// <typeparam name="TVisual3D">The type of visual in the list.</typeparam>
    public class UpdatableVisual3DList<TVisual3D> : ModelVisual3D
        where TVisual3D : Visual3D, new()
    {
        // The collection of child visuals.
        private readonly List<TVisual3D> visuals = new ();
        ...
        public delegate void NewVisualHandler(TVisual3D newVisual);
