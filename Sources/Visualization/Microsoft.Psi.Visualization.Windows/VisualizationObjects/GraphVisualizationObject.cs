...
namespace Microsoft.Psi.Visualization.VisualizationObjects
{
    ...
    public abstract class GraphVisualizationObject<TNodeVisual3D, TEdgeVisual3D, TNodeKey, TNode, TEdge> :
        ModelVisual3DValueVisualizationObject<Graph<TNodeKey, TNode, TEdge>>
        where TNodeVisual3D : Visual3D, new()
        where TEdgeVisual3D : Visual3D, new()
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GraphVisualizationObject{TNodeVisualizationObject, TEdgeVisualizationObject, TNodeKey, TNode, TEdge}"/> class.
        /// </summary>
        ...
        public GraphVisualizationObject(
