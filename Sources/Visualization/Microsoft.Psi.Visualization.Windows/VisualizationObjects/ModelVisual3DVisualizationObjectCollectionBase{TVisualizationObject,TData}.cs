...
namespace Microsoft.Psi.Visualization.VisualizationObjects
{
    ...
    public abstract class ModelVisual3DVisualizationObjectCollectionBase<TVisualizationObject, TData> : ModelVisual3DVisualizationObject<TData>
        where TVisualizationObject : VisualizationObject, IModelVisual3DVisualizationObject, ICustomTypeDescriptor, new()
    {
        ...
        private readonly Dictionary<string, object> updatedPrototypeProperties = new Dictionary<string, object>();
        ...
        protected TVisualizationObject CreateNew()
        {
            ...
            TVisualizationObject visualizationObject = new TVisualizationObject();
