...
namespace Microsoft.Psi.PsiStudio.TypeSpec
{
    ...
    public class TypeSpec
    {
        ...
        /// <summary>
        /// Returns a string representation of the type as could be written in code.
        /// </summary>
        /// <param name="type">The type.</param>
        /// <returns>The friendly name of the type.</returns>
        public static string GetCodeFriendlyName(Type type)
        {
            string fullName = type.Name;
            if (type.IsGenericType)
            {
                return fullName.Split('`')[0] + "<" + string.Join(", ", type.GetGenericArguments().Select(t => TypeSpec.GetCodeFriendlyName(t)).ToArray()) + ">";
            }
