...
namespace Microsoft.Psi.PsiStudio
{
    ...
    public class PsiSettings
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PsiSettings"/> class.
        /// </summary>
        public PsiSettings()
        {
        ...
        /// <summary>
        /// Finalizes an instance of the <see cref="PsiSettings"/> class.
        /// </summary>
        ~PsiSettings()
        {
            using (var writer = XmlWriter.Create(this.settingsFilename, new XmlWriterSettings() { Indent = true }))
            {
                var xmlSerializer = new XmlSerializer(typeof(PsiSettings));
