...
namespace Microsoft.Psi.Visualization.Summarizers
{
    ...
    /// </summary>
    /// <typeparam name="T">The type of the object to summarize.</typeparam>
    [DataContract(Namespace = "http://www.microsoft.com/psi")]
    public class ObjectSummarizer<T> : Summarizer<T, object>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectSummarizer{ThisAssembly}"/> class.
        /// </summary>
