...
namespace Microsoft.Psi.Visualization.Views.Visuals2D
{
    ...
    public class PlotVisualizationObjectView<TPlotVisualizationObject, TData, TConfig> : TimelineCanvasVisualizationObjectView<TPlotVisualizationObject, TData, TConfig>
        where TPlotVisualizationObject : PlotVisualizationObject<TData, TConfig>, new()
        where TConfig : PlotVisualizationObjectConfiguration, new()
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlotVisualizationObjectView{TTimelineVisualizationObject, TData, TConfig}"/> class.
        /// </summary>
        ...
        /// <inheritdoc/>
        protected override void OnVisualizationObjectConfigurationPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            base.OnVisualizationObjectConfigurationPropertyChanged(sender, e);
        ...
        protected override bool UpdateTransforms()
        {
            ...
            double maxY = this.VisualizationObject.Configuration.YMax;
            double minY = this.VisualizationObject.Configuration.YMin;
            if (maxY == minY)
            {
                maxY += 1;
                minY -= 1;
        ...
        private class Segment
        {
            ...
            private PlotVisualizationObjectView<TPlotVisualizationObject, TData, TConfig> parent;
            ...
            public Segment(PlotVisualizationObjectView<TPlotVisualizationObject, TData, TConfig> parent)
            {
                this.parent = parent;
                ...
                var binding = new Binding(nameof(parent.VisualizationObject.Configuration) + "." + nameof(PlotVisualizationObjectConfiguration.Color))
                {
                ...
                binding = new Binding(nameof(parent.VisualizationObject.Configuration) + "." + nameof(PlotVisualizationObjectConfiguration.LineWidth))
                {
                    Source = parent.VisualizationObject,
                };
                ...
                binding = new Binding(nameof(parent.VisualizationObject.Configuration) + "." + nameof(PlotVisualizationObjectConfiguration.MarkerColor))
                {
                    Source = parent.VisualizationObject,
                    Converter = new Converters.ColorConverter(),
                };
                ...
                binding = new Binding(nameof(parent.VisualizationObject.Configuration) + "." + nameof(PlotVisualizationObjectConfiguration.RangeColor))
                {
                    Source = parent.VisualizationObject,
                    Converter = new Converters.ColorConverter(),
                };
                ...
                binding = new Binding(nameof(parent.VisualizationObject.Configuration) + "." + nameof(PlotVisualizationObjectConfiguration.RangeWidth))
                {
                    Source = parent.VisualizationObject,
                };
            ...
            public void PlotLine(Point point)
            {
                ...
                InterpolationStyle interpolationStyle = this.parent.VisualizationObject.Configuration.InterpolationStyle;
            ...
            {
                var markerSizeX = this.parent.VisualizationObject.Configuration.MarkerSize / this.parent.ScaleTransform.ScaleX;
                var markerSizeY = this.parent.VisualizationObject.Configuration.MarkerSize / this.parent.ScaleTransform.ScaleY;

                var markerFigure = new PathFigure();

                if (this.parent.VisualizationObject.Configuration.MarkerStyle == MarkerStyle.Plus)
                {
                ...
                else if (this.parent.VisualizationObject.Configuration.MarkerStyle == MarkerStyle.Cross)
                {
                ...
                else if (this.parent.VisualizationObject.Configuration.MarkerStyle == MarkerStyle.Asterisk)
                {
                    markerFigure.StartPoint = new Point(point.X - (markerSizeX / 2), point.Y - (markerSizeY / 2));
                    markerFigure.Segments.Add(new LineSegment(new Point(point.X + (markerSizeX / 2), point.Y + (markerSizeY / 2)), true));
                    markerFigure.Segments.Add(new LineSegment(new Point(point.X - (markerSizeX / 2), point.Y + (markerSizeY / 2)), false));
                ...
                else if (this.parent.VisualizationObject.Configuration.MarkerStyle == MarkerStyle.Circle)
                {
                ...
                else if (this.parent.VisualizationObject.Configuration.MarkerStyle == MarkerStyle.Square)
                {
                    markerFigure.StartPoint = new Point(point.X - (markerSizeX / 2), point.Y - (markerSizeY / 2));
                    markerFigure.Segments.Add(new LineSegment(new Point(point.X - (markerSizeX / 2), point.Y + (markerSizeY / 2)), true));
                    markerFigure.Segments.Add(new LineSegment(new Point(point.X + (markerSizeX / 2), point.Y + (markerSizeY / 2)), true));
                ...
                else if (this.parent.VisualizationObject.Configuration.MarkerStyle == MarkerStyle.DownTriangle)
                {
                    markerFigure.StartPoint = new Point(point.X, point.Y + (markerSizeY / 2));
                    markerFigure.Segments.Add(new LineSegment(new Point(point.X - (markerSizeX / 2), point.Y - (markerSizeY / 2)), true));
                    markerFigure.Segments.Add(new LineSegment(new Point(point.X + (markerSizeX / 2), point.Y - (markerSizeY / 2)), true));
                ...
                else if (this.parent.VisualizationObject.Configuration.MarkerStyle == MarkerStyle.UpTriangle)
                {
                    markerFigure.StartPoint = new Point(point.X, point.Y - (markerSizeY / 2));
                    markerFigure.Segments.Add(new LineSegment(new Point(point.X - (markerSizeX / 2), point.Y + (markerSizeY / 2)), true));
                    markerFigure.Segments.Add(new LineSegment(new Point(point.X + (markerSizeX / 2), point.Y + (markerSizeY / 2)), true));
                ...
                else if (this.parent.VisualizationObject.Configuration.MarkerStyle == MarkerStyle.Diamond)
                {
            ...
            public void ClearMarkers()
            {
                ...
                if ((this.parent.VisualizationObject.Configuration.MarkerStyle == MarkerStyle.Circle) ||
                    (this.parent.VisualizationObject.Configuration.MarkerStyle == MarkerStyle.Square) ||
                    (this.parent.VisualizationObject.Configuration.MarkerStyle == MarkerStyle.UpTriangle) ||
                    (this.parent.VisualizationObject.Configuration.MarkerStyle == MarkerStyle.DownTriangle) ||
                    (this.parent.VisualizationObject.Configuration.MarkerStyle == MarkerStyle.Diamond))
                {
                    this.MarkerPath.Fill = new SolidColorBrush(this.parent.VisualizationObject.Configuration.MarkerColor);
                }
                else
                {
