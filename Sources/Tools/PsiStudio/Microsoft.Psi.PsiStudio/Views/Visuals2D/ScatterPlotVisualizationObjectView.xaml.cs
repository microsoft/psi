...
namespace Microsoft.Psi.Visualization.Views.Visuals2D
{
    ...
    public partial class ScatterPlotVisualizationObjectView : UserControl
    {
        ...
        private void ScatterPlotVisualizationObjectView_DataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            this.ScatterPlotVisualizationObject.Configuration.PropertyChanged += this.Configuration_PropertyChanged;
        }

        private void Configuration_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == nameof(ScatterPlotVisualizationObjectConfiguration.XMax) ||
                e.PropertyName == nameof(ScatterPlotVisualizationObjectConfiguration.XMin) ||
                e.PropertyName == nameof(ScatterPlotVisualizationObjectConfiguration.YMax) ||
                e.PropertyName == nameof(ScatterPlotVisualizationObjectConfiguration.YMin))
            {
                this.CalculatePlacementTransform();
            }
        }
        ...
        {
            if (e.PropertyName == nameof(this.ScatterPlotVisualizationObject.Configuration))
            {
                this.ScatterPlotVisualizationObject.Configuration.PropertyChanged += this.Configuration_PropertyChanged;
                this.CalculatePlacementTransform();
            }
        ...
        {
            var contentHeight = this.ScatterPlotVisualizationObject.Configuration.YMax - this.ScatterPlotVisualizationObject.Configuration.YMin;
            var contentWidth = this.ScatterPlotVisualizationObject.Configuration.XMax - this.ScatterPlotVisualizationObject.Configuration.XMin;
            ...
            this.xPlacementConverter.Offset = -this.ScatterPlotVisualizationObject.Configuration.XMin;
            this.yPlacementConverter.Offset = -this.ScatterPlotVisualizationObject.Configuration.YMin;
        }
    }
}
