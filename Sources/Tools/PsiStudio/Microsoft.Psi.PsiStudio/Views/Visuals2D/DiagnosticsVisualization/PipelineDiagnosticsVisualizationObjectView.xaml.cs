...
namespace Microsoft.Psi.Visualization.Views.Visuals2D
{
    ...
    public partial class PipelineDiagnosticsVisualizationObjectView : UserControl
    {
        ...
        private void DiagnosticsVisualizationObjectView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            this.presenter = new PipelineDiagnosticsVisualizationPresenter(this, this.DiagnosticsVisualizationObject.Configuration);
        }
        ...
        private void DiagnosticsVisualizationObjectView_DataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            this.DiagnosticsVisualizationObject.PropertyChanged += this.DiagnosticsVisualizationObject_PropertyChanged;
            this.DiagnosticsVisualizationObject.Configuration.PropertyChanged += this.Configuration_PropertyChanged;
        }
        ...
        private void UpdateViewerGraph()
        {
            this.statusText.Content = $"{this.presenter.DiagnosticsGraph.Name} (nodes={this.presenter.DiagnosticsGraph.PipelineElements.Count})";
        ...
        {
            this.presenter.UpdateConfig(this.DiagnosticsVisualizationObject.Configuration);
            if (e.PropertyName == nameof(Config.DiagnosticsVisualizationObjectConfiguration.LayoutDirection))
            {
        ...
        {
            if (e.PropertyName == nameof(this.DiagnosticsVisualizationObject.CurrentValue) && this.DiagnosticsVisualizationObject.CurrentValue != null)
            {
                this.presenter.UpdateGraph(this.DiagnosticsVisualizationObject.CurrentValue.Value.Data);
            }
        }
