...
namespace Microsoft.Psi.Visualization.Views.Visuals2D
{
    ...
    public class PlotVisualizationObjectView<TTimelineVisualizationObject, TConfig> : TimelineCanvasVisualizationObjectView<TTimelineVisualizationObject, double, TConfig>
        where TTimelineVisualizationObject : PlotVisualizationObject<TConfig>, new()
        where TConfig : PlotVisualizationObjectConfiguration, new()
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlotVisualizationObjectView{TTimelineVisualizationObject, TConfig}"/> class.
        /// </summary>
        ...
        private class Segment
        {
            ...
            private PlotVisualizationObjectView<TTimelineVisualizationObject, TConfig> parent;
            ...
            public Segment(PlotVisualizationObjectView<TTimelineVisualizationObject, TConfig> parent)
            {
                this.parent = parent;
