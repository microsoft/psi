...
namespace Microsoft.Psi.Visualization.Views.Visuals3D
{
    ...
    public class PointsVisual : ModelVisual3D
    {
        ...
        private void UpdateProperties()
        {
            ...
            {
                sphere.Radius = this.visualizationObject.Configuration.Size;
                sphere.Fill = brush;
            }
        }
        ...
        {
            if (e.PropertyName == nameof(Points3DVisualizationObjectConfiguration.Color) || e.PropertyName == nameof(Points3DVisualizationObjectConfiguration.Size))
            {
        ...
        {
            if (e.PropertyName == nameof(Points3DVisualizationObject.Configuration))
            {
                this.visualizationObject.Configuration.PropertyChanged += this.Configuration_PropertyChanged;
                this.UpdateProperties();
            }
