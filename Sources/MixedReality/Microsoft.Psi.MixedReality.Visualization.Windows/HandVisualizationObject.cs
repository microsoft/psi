...
namespace Microsoft.Psi.MixedReality.Visualization
{
    ...
    public class HandVisualizationObject : ModelVisual3DVisualizationObject<Hand>
    {
        ...
        {
            this.Joints = new ();
            this.Joints.EdgeDiameterMm = 10;
            this.Joints.NodeRadiusMm = 7;
            this.Joints.NodeColor = Colors.Silver;
            this.Joints.EdgeColor = Colors.Gray;
        ...
        private void UpdateVisibility()
        {
            ...
            var trackedVisible = this.ShowTrackedOnly ? visible && this.CurrentData.IsTracked : visible;

            this.UpdateChildVisibility(this.Joints.ModelView, trackedVisible);
        }
    }
}
