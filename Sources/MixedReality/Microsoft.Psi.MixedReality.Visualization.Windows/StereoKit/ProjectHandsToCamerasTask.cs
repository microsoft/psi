...
namespace Microsoft.Psi.MixedReality.StereoKit.Visualization
{
    ...
    /// </summary>
    [BatchProcessingTask(
        "Project StereoKit Hands to Cameras",
    ...
    public class ProjectHandsToCamerasTask : BatchProcessingTask<ProjectHandsToCamerasTaskConfiguration>
    {
            ...
            where TCamera : CameraView<T>
        {
            ...
            return cameraStream.Join(
                    handStream,
                    new AdjacentValuesInterpolator<StereoKit.Hand>(
                        StereoKit.Operators.InterpolateHands,
                        false,
                        name: nameof(StereoKit.Operators.InterpolateHands)))
