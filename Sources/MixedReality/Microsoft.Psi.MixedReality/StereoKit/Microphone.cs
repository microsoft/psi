...
namespace Microsoft.Psi.MixedReality.StereoKit
{
    ...
    public class Microphone : StereoKitComponent, IProducer<AudioBuffer>, ISourceComponent
    {
        ...
        {
            if (!global::StereoKit.Microphone.Start())
            {
        ...
        /// <inheritdoc/>
        public override void Shutdown() => global::StereoKit.Microphone.Stop();
        ...
        {
            int unreadSamples = global::StereoKit.Microphone.Sound.UnreadSamples;
            ...
            if (this.active && global::StereoKit.Microphone.IsRecording && unreadSamples > 1)
            {
                ...
                int samples = global::StereoKit.Microphone.Sound.ReadSamples(ref this.buffer);
