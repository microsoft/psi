...
namespace Microsoft.Psi.MixedReality
{
    ...
    /// </summary>
    public class HandsStereoKitRenderer
    {
        private readonly string name;
        private readonly Material material = Default.MaterialHand;

        /// <summary>
        /// Initializes a new instance of the <see cref="HandsStereoKitRenderer"/> class.
        /// </summary>
        ...
        public HandsStereoKitRenderer(Pipeline pipeline, bool visible = true, bool solid = false, string name = nameof(HandsStereoKitRenderer))
        {
            this.name = name;
