...
namespace Microsoft.Psi.MixedReality
{
    ...
    /// <summary>
    /// Component that visually renders a single mesh.
    /// </summary>
    public class MeshStereoKitRenderer : StereoKitRenderer
    {
        ...
        public MeshStereoKitRenderer(Pipeline pipeline, Mesh mesh, CoordinateSystem pose, Vector3D scale, Color color, bool wireframe = false, bool visible = true, string name = nameof(MeshStereoKitRenderer))
            : base(pipeline, name)
        {
            this.Mesh = mesh;
        ...
        /// <param name="visible">Visibility.</param>
        /// <param name="name">An optional name for the component.</param>
        public MeshStereoKitRenderer(Pipeline pipeline, Mesh mesh, Color color, bool wireframe = false, bool visible = true, string name = nameof(MeshStereoKitRenderer))
