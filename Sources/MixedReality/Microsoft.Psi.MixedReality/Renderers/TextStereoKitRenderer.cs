...
namespace Microsoft.Psi.MixedReality
{
    ...
    /// </summary>
    public class TextStereoKitRenderer : StereoKitRenderer
    {
        ...
        private readonly TextStereoKitRendererConfiguration configuration;

        private Matrix pose;
        private TextStyle textStyle;
        private StereoKit.Color billboardBorderColor;
        private Matrix billboardFillTransform;

        /// <summary>
        /// Initializes a new instance of the <see cref="TextStereoKitRenderer"/> class.
        /// </summary>
        /// <param name="pipeline">The pipeline to add the component to.</param>
        /// <param name="configuration">Configuration to use.</param>
        /// <param name="name">An optional name for the component.</param>
        public TextStereoKitRenderer(Pipeline pipeline, TextStereoKitRendererConfiguration configuration = null, string name = nameof(TextStereoKitRenderer))
            : base(pipeline, name)
        {
            this.configuration = configuration ?? new TextStereoKitRendererConfiguration();
            ...
            if (this.configuration.Visible)
            {
                ...
                if (!string.IsNullOrEmpty(this.configuration.Text))
                {
                    ...
                    StereoKit.Text.Add(
                            ...
                            Matrix.Identity,
                            this.configuration.DesiredTextSize ?? StereoKit.Text.Size(this.configuration.Text),
        ...
        private void UpdateTextStyle()
        {
            ...
            this.textStyle = StereoKit.Text.MakeStyle(this.configuration.TextFont, TextStyle.Default.CharHeight, colorGamma);
        }
