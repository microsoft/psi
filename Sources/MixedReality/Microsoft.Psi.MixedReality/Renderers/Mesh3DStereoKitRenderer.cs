...
namespace Microsoft.Psi.MixedReality
{
    ...
    /// </summary>
    public class Mesh3DStereoKitRenderer : MeshStereoKitRenderer, IConsumer<Mesh3D>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Mesh3DStereoKitRenderer"/> class.
        /// </summary>
        ...
        /// <param name="visible">Visibility.</param>
        /// <param name="name">An optional name for the component.</param>
        public Mesh3DStereoKitRenderer(Pipeline pipeline, Mesh3D mesh3D, Color color, bool wireframe = false, bool visible = true, string name = nameof(Mesh3DStereoKitRenderer))
