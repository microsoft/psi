...
namespace Microsoft.Psi.Interop.Serialization
{
    ...
    /// <summary>
    /// Helper class for making new formats (implementations of <see cref="IFormatSerializer{T}"/>/<see cref="IFormatDeserializer{T}"/>.
    /// </summary>
    /// <typeparam name="T">Type which is serialized/deserialized.</typeparam>
    public class Format<T> : IFormatSerializer<T>, IFormatDeserializer<T>, IDisposable
    {
